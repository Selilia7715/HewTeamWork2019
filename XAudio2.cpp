...
{
	{"data/BGM/grassland_short_loop.wav", true},	 // TitleBGM
	{"data/BGM/tavern_loop.wav", true},				 // GameOverBGM
	{"data/BGM/tension_loop.wav", true},			 // GameBGM
	{"data/BGM/Chiptuna_Sandwich.wav", true},		 // StageClearBGM
	{"data/SE/Coin.wav", false},			// サンプルSE（ループしないのでfalse設定）
	{"data/SE/Explosion.wav", false},		// サンプルSE
	{"data/SE/GameOver.wav", false},		// サンプルSE
	{"data/SE/Hit.wav", false},			// サンプルSE
	{"data/SE/Jump.wav", false},		// サンプルSE
	{"data/SE/Laser.wav", false},		// サンプルSE
	{"data/SE/PowerUp.wav", false},		// サンプルSE
	{"data/SE/Shot.wav", false},		// サンプルSE
};
